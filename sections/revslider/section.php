...
class plRevSlider extends PageLinesSection {
	...
	function section_styles(){
		...
		wp_enqueue_script( 'revolution', $this->base_url.'/rs-plugin/js/jquery.themepunch.revolution.min.js', array( 'jquery' ), pl_get_cache_key(), true );
	...
	function get_video_caption( $source1 = '', $source2 = ''){
		...
		<div class="bg-video-viewport" style="position: absolute; top: 0; left: 0;">
		 <video class="bg-video" preload="none" width="100%" height="100%"
